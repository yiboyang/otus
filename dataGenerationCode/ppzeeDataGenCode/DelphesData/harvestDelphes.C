  ...
  for(Int_t entry = 0; entry < numberOfEntries; ++entry)
    {
      ...
      //Skip any event that has eleNu != 2
      if(eleNu != 2)
	{
	  continue;
	}
      //Skip any event with non-zero muNu, phNu, or jetNu
      if(muNu != 0 || phNu != 0 || jetNu != 0)
	{
	  continue;
	}

      //Skip any event that has two electrons of the same charge
      nTestE = 0;
      nTestP = 0;
